...
// Открытие модалки при клике на видео (или на весь элемент галереи)
document.querySelectorAll('.gallery-item video').forEach(video => {
    video.addEventListener('click', (e) => {
        e.stopPropagation(); // чтобы не сработало всплытие на родителя
...
closeBtn.addEventListener('click', () => {
    ...
    modalVideo.pause();
    modalVideo.src = ''; // сброс src, чтобы остановить загрузку
});
